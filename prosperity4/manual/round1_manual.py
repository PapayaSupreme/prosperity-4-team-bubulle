...
DRYLAND_FLAX = ProductConfig(
    name="DRYLAND_FLAX", # CLEARING PRICE: 28 for 40 000
    bids={
        30: 30000, #  30: 30K   30: 39K
        29: 5000,  #  29: 35K   29: 44K
        28: 12000, #  28: 47K   28: 56K
        27: 28000, #  27: 75K   27: 84K
    },
    asks={
        28: 40000, #  28: 40K
        31: 20000, #  31: 60K
        32: 20000, #  32: 80K
        33: 30000, #  33: 110K
    },  # SO: 27 = 0, 28 = 40K, 29 = 35K, 30 = 30K
    liquidation_price=30.0,
    fee_per_traded_unit=0.0,
)

EMBER_MUSHROOM = ProductConfig(
    name="EMBER_MUSHROOM", # CLEARING PRICE: 15 for 86 000
    bids={
        20: 43000, # =  20: 43K
        19: 17000, # >= 19: 60K
        18: 6000,  # >= 18: 66K
    ...
    asks={
        ...
        18: 10000, # <= 18: 101K
        19: 12000, # <= 19: 113K
    },  # SO : 12 = 20K, 13 = 45K, 14 = 80K, 15 = 86K, 16 = 81K
