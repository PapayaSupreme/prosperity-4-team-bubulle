#FROM v4.1 - implements insider trading with a mix of hedgehogs and proprietary. options still disabled
#PnL: 8 033 (Mark 14 on Hydrogel, Mark 01 on Velvetfruit)
import json
import math
